...
class BubbleFlyEffect extends StatefulWidget implements EffectWidget {
  final Offset startPosition;
  final double size;

  const BubbleFlyEffect({
    super.key,
  ...
  @override
  State<BubbleFlyEffect> createState() => _BubbleFlyEffectState();
}

class _BubbleFlyEffectState extends State<BubbleFlyEffect>
