...
class CloudFlyEffect extends StatefulWidget implements EffectWidget {
  final Offset startPosition;
  final double size;

  const CloudFlyEffect({
    super.key,
  ...
  @override
  State<CloudFlyEffect> createState() => _CloudFlyEffectState();
}

class _CloudFlyEffectState extends State<CloudFlyEffect>
